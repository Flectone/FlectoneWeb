...
<dependency>
    ...
    <version>1.7.3</version> <!-- Замените на актуальную версию -->
...
dependencies {
    compileOnly 'net.flectone.pulse:core:1.7.3' // Замените на актуальную версию
}
```
...
<dependency>
    <groupId>net.flectone.pulse</groupId>
    <artifactId>core</artifactId>
    <version>1.7.4-SNAPSHOT</version> <!-- Замените на актуальную версию -->
    <scope>provided</scope>
</dependency>
```
...
dependencies {
    compileOnly 'net.flectone.pulse:core:1.7.4-SNAPSHOT' // Замените на актуальную версию
}
```
