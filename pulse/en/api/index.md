...
<dependency>
    ...
    <version>1.7.3</version> <!-- Replace with latest version -->
...
dependencies {
    compileOnly 'net.flectone.pulse:core:1.7.3' // Replace with latest version
}
```
...
<dependency>
    <groupId>net.flectone.pulse</groupId>
    <artifactId>core</artifactId>
    <version>1.7.4-SNAPSHOT</version> <!-- Replace with latest version -->
    <scope>provided</scope>
</dependency>
```
...
dependencies {
    compileOnly 'net.flectone.pulse:core:1.7.4-SNAPSHOT' // Replace with latest version
}
```
...
- For registering listeners, use `ListenerRegistry.class` and the `registerPermanent()` method