    ...
    const tools: ToolConfig[] = [
        {
            ...
            preview:
                <div className="font-[Minecraft] bg-[url(/assets/minecraft_taiga.webp)] bg-center h-full bg-cover">
        ...
        },
        {
            ...
            preview:
                <div className=" text-fd-primary h-full bottom-0 p-2 flex justify-center items-center font-[Minecraft] bg-[url(/assets/minecraft_landscape.webp)] bg-bottom border">
        ...
        },
        {
            ...
            preview:
                <div className="font-[Minecraft] bg-[url(/assets/minecraft_clouds.webp)] bg-center h-full bg-cover flex items-center justify-center">
        ...
        },
        {
            ...
            preview:
                <div className="font-[Minecraft] bg-[url(/assets/minecraft_jungle.webp)] h-full bg-cover flex items-center justify-center">
        ...
        },
        {
            ...
            preview:
                <div className="font-[Minecraft] bg-[url(/assets/minecraft_nether_2.webp)] h-full bg-cover flex items-center justify-center">
        ...
        },
        {
            ...
            preview:
                <div className="font-[Minecraft] bg-[url(/assets/time.webp)] bg-center h-full bg-cover flex items-center justify-center">
                    <img src="/assets/sun.webp" alt="" className="h-full animate-spin [animation-duration:4s]" />
                </div>
        },
    ]
