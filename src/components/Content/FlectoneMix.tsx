  ...
  return (
    <div className="flex w-full max-xl:w-2xl mt-6 max-md:w-full max-xl:flex-col ">
      <Card className="mr-4 w-sm flex flex-col justify-between max-xl:w-full max-xl:my-4">
        ...
        <div className="flex justify-center flex-col gap-2 justify-start">
          <LinkButton mode="gray" className="flex items-center" href="https://github.com/Flectone/FlectoneMix"><SiGithub
            className="mr-1" size={'16px'}/>GitHub</LinkButton>
