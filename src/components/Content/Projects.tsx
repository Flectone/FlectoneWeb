      ...
      <div className="h-max w-full flex gap-4 flex-col">
        <div className="flex gap-4">
          <Card path='/pulse' className="w-full h-full max-md:h-fit items-center flex justify-between p-10 relative">
            ...
            <div className='sm:hidden'>
              <h1 className='text-2xl max-md:text-xl max-sm:text-sm font-bold'>Flectone<b>Pulse</b></h1>
              <p className='w-2/3 max-md:text-md max-sm:text-xs'>{t('Pulse.description')}</p>
            </div>
        ...
        <div className="flex w-full max-xl:flex-col gap-4">
          <FeatureCard
            ...
            image={'/mix/mix.svg'}
            title={<h1 className='text-2xl max-md:text-xl max-sm:text-sm font-bold'>Flectone<b>Mix</b></h1>}
            description={<p className={'w-2/3 max-md:text-md max-sm:text-xs'}>{t('Mix.description')}</p>}
            imagePosition={'right'}
          />
          <FeatureCard
            link={'/chat'}
            ...
            title={<h1 className='text-2xl max-md:text-xl max-sm:text-sm font-bold'>Flectone<b>Chat</b></h1>}
            description={<p className={'w-2/3 max-md:text-md max-sm:text-xs'}>{t('Chat.description')}</p>}
            imagePosition={'right'}
          />
        </div>
      </div>
