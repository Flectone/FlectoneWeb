  ...
  return (
    ...
    >
      ...
      <SearchDialogContent className="overflow-visible">
        ...
        <SearchDialogFooter className="flex flex-row rounded-2xl px-1 py-1">
          <TagList currentTag={tag || "minecraft"}>
            <TagListItem
              isSelect={tag == "minecraft"}
              icon={"pickaxe"}
              title={t("Minecraft.name")}
              description={t("Minecraft.description")}
              onclick={() => setTag("minecraft")}
            />
            <TagListItem
              isSelect={tag == "hytale"}
              icon={"leaf"}
              title={t("Hytale.name")}
              description={t("Hytale.description")}
              onclick={() => setTag("hytale")}
            />
            <TagListItem
              isSelect={tag == "api"}
