    ...
    return (
        <div className='w-full max-lg:p-8 rounded-2xl bg-[url(/square.svg)] not-dark:bg-[url(/squaredark.svg)] bg-size-[36px] border overflow-hidden bg-fd-card/85 backdrop-blur-3xl flex px-16 py-4 justify-between items-center gap-8'>
            ...
            <div className='flex flex-col gap-4'>
                <h1 className='text-4xl w-96 text-start font-bold'>Каждое сообщение под <b className='font-black'>вашим</b> контролем!</h1>
                <div className='flex gap-4'>
                    <LinkButton href='/pulse/docs' mode='blue' className='h-8'>Документация</LinkButton>
                    <LinkButton href='/pulse/metrics' mode='gray' className='h-8'>Аналитика</LinkButton>
                    <LinkButton href='https://modrinth.com/plugin/flectonepulse' mode='gray' className='h-8'>Скачать</LinkButton>
                </div>
            </div>
