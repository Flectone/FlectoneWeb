        ...
        <div className='w-full flex gap-8 max-[52rem]:flex-col'>
            <Card path='/pulse/docs/message' className='w-1/3 max-[52rem]:w-full max-[52rem]:h-92 not-dark:border h-72'>
                ...
                <div className='text-start flex flex-col gap-2'>
                    <h2 className='font-medium'>Настройка множества сообщений</h2>
                    <p className=''>Настрой почти любое сообщение, которое видит твой игрок. Любое действие FlectonePulse можно отключить</p>
                </div>
            ...
            <Card path='/pulse/docs/command' className='not-dark:border w-1/3 h-72 max-[52rem]:w-full max-[52rem]:h-92'>
                ...
                <div className='text-start flex flex-col gap-2'>
                    <h2 className='font-medium'>Более 30 интересных комманд</h2>
                    <p className=''>Сделай чат более удобным в использовании. Игроки также смогут использовать встроенные мини-игры</p>
                </div>
            ...
            <Card path='/pulse/docs/integration' className='not-dark:border w-1/3 h-72 max-[52rem]:w-full max-[52rem]:h-92'>
                ...
                <div className='text-start flex flex-col gap-2'>
                    <h2 className='font-medium'>Интеграция с другими проектами</h2>
                    <p className=''>Позволь игрокам общаться на разных платформах. Полноценные интеграции с Discord, Twitch и Telegram</p>
                </div>
