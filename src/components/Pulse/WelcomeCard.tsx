...
export default function WelcomeCard() {
  ...
  return (
    <div className='w-full max-lg:p-8 rounded-2xl bg-size-[36px] border overflow-hidden bg-fd-card/85 backdrop-blur-3xl flex px-16 py-12 justify-between items-center gap-8'>
