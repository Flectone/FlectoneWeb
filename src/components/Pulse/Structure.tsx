...
export default function Structure() {
  ...
  return (
    <div className="w-full flex items-center flex-col gap-3 h-auto">
      <h1 className='text-2xl text-center font-bold border-b border-fd-foreground w-fit px-4 pb-2'>{t('title')}</h1>
      <Files className="rounded-2xl flex flex-col justify-start text-start p-1 w-full">
