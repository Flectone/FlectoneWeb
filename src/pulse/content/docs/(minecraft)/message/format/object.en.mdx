...
![object](/pulse/message_format_object.webp)
![texturemotd](/pulse/message_format_object_texture_motd.webp)
![texture](/pulse/message_format_object_texture.webp)
![texturesidebar](/pulse/message_format_object_texture_sidebar.webp)
...
![command sprite](/pulse/command_sprite.webp)
...
For example, there is a `gui` atlas named `minecraft_textures_atlas_gui.png.txt`. In it, you can find a line with `minecraft:container/slot	x=494	y=54	w=18	h=18`
...
![object slot](/pulse/message_format_object_slot.webp)
...
<Callout type="info" title="Information">
    ...
    ![flectonetools](/pulse/flectonetools.webp)
