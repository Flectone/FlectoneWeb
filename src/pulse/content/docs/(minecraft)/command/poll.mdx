...
Название дополнительной комманды, которая будет использоваться для голосования (оно всегда добавляется к текущему названию т.е. будет `/pollvote`)

### `sub_command_gui`

Название дополнительной комманды, которая будет использоваться для вызова GUI создания голосования (оно всегда добавляется к текущему названию т.е. будет `/pollgui`)
