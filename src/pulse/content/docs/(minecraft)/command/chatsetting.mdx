...
<Callout type="info" title="Информация">
    ...
    \
    \
    Доступные настройки для /chatsetting можно найти тут [ModuleName](https://github.com/Flectone/FlectonePulse/blob/master/api/src/main/java/net/flectone/pulse/constant/ModuleName.java) и тут [SettingText](https://github.com/Flectone/FlectonePulse/blob/master/core/src/main/java/net/flectone/pulse/util/constant/SettingText.java)
