...
![twitch message](/pulse/integration_twitch_message.webp)
![minecraft message](/pulse/integration_twitch_message_minecraft.webp)
...
<Tabs items={['en_us', 'ru_ru']}>
    <Tab value="en_us"><include>../../../../files/minecraft/localizations/en_us.yml#twitch</include></Tab>
    <Tab value="ru_ru"><include>../../../../files/minecraft/localizations/ru_ru.yml#twitch</include></Tab>
</Tabs>
...
<Callout type="info" title="Information">
Example for a ban message. There is a `<reason>` placeholder there, which means I can use `<reason>` inside Twitch messages.
</Callout>
...
<include>../../../../files/minecraft/integration.yml#twitch</include>
...
<Callout type="info" title="Information">
For example, I want Minecraft `/ban` command messages to be sent to Twitch
<Steps>
    <Step>
...
A list where the key is the channel name and the value is a list of commands to be executed when the stream starts/ends.

<Callout type="info" title="Info">
For example, I want to track when `faseri4ka` starts streaming and run `stream start https://twitch.tv/faseri4ka`
<Steps>
    <Step>
...
- You can have any number and any type of commands for stream start/end
</Callout>
...
<include>../../../../files/minecraft/permission.yml#twitch</include>
