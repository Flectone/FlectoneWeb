...
<Tabs items={['en_us', 'ru_ru']}>
    <Tab value="en_us"><include>../../../../files/minecraft/localizations/en_us.yml#telegram</include></Tab>
    <Tab value="ru_ru"><include>../../../../files/minecraft/localizations/ru_ru.yml#telegram</include></Tab>
</Tabs>
...
<include>../../../../files/minecraft/integration.yml#telegram</include>
...
There can be any number of chats, as long as the bot from [`token`](/pulse/docs/integration/telegram/#token) has access to them. Localization configuration is optional; by default, the message will be sent with the `<final_message>` format.
</Callout>
...
<include>../../../../files/minecraft/permission.yml#telegram</include>
