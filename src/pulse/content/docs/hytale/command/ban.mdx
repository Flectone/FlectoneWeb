...
Сообщение, если включен `check_duplicate` и у игрока, которому хотят выдать бан, уже он есть
...
Если включено, то игроку с активным баном, нельзя будет выдать ещё один бан
