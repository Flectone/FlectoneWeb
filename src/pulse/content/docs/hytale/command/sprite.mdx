...
- Каждый атлас скачивается с собственного веб-сервера Flectone по ссылке `https://flectone.net/files/hytale/r/minecraft/<version>/atlases/minecraft_textures_atlas_<atlas>.png.txt`
