...
| `%flectonepulse_afk_suffix%`                | Returns [AFK suffix](/pulse/docs/hytale/command/afk/)                         |
...
| `%flectonepulse_fcolor_number%`             | Returns the player's [custom color](/pulse/docs/hytale/message/format/fcolor/)     |
| `%flectonepulse_fcolor_out_number%`         | Returns the player's [custom OUT color](/pulse/docs/hytale/message/format/fcolor/) |
| `%flectonepulse_fcolor_see_number%`         | Returns the player's [custom SEE color](/pulse/docs/hytale/message/format/fcolor/) |
...
| `%flectonepulse_stream_prefix%`             | Returns the player's [stream prefix](/pulse/docs/hytale/message/command/stream/)     |
...
| `%flectonepulse_world_prefix%`              | Returns the player's [world prefix](/pulse/docs/hytale/message/format/world/)        |
| `%flectonepulse_mute_suffix%`               | Returns the player's [mute suffix](/pulse/docs/hytale/command/mute/)                |
