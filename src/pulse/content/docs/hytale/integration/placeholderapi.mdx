...
| `%flectonepulse_afk_suffix%`                | Возвращает [AFK суффикс](/pulse/docs/hytale/command/afk/)                         |
...
| `%flectonepulse_fcolor_number%`             | Возвращает [кастомный цвет](/pulse/docs/hytale/message/format/fcolor/) игрока     |
| `%flectonepulse_fcolor_out_number%`         | Возвращает [кастомный цвет OUT](/pulse/docs/hytale/message/format/fcolor/) игрока |
| `%flectonepulse_fcolor_see_number%`         | Возвращает [кастомный цвет SEE](/pulse/docs/hytale/message/format/fcolor/) игрока |
...
| `%flectonepulse_stream_prefix%`             | Возвращает [стрим префикс](/pulse/docs/hytale/message/command/stream/) игрока     |
...
| `%flectonepulse_world_prefix%`              | Возвращает [префикс мира](/pulse/docs/hytale/message/format/world/) игрока        |
| `%flectonepulse_mute_suffix%`               | Возвращает [суффикс мута](/pulse/docs/hytale/command/mute/) игрока                |
