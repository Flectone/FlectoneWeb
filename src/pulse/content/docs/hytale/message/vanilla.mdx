...
Ты можешь добавить любое сообщение. Нужно использовать ключ перевода из главной локализации сервера, добавив вначало ключа слово `server.`, чтобы в итоге получилось `server.key: "hello <argument:0>"`
