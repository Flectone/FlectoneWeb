...
<span><include>../../../parts/words.mdx#path</include> `integration.yml → libertybans`</span>
...
<span><include>../../../parts/words.mdx#path</include> `permission.yml → integration.libertybans`</span>
