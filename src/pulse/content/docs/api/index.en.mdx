...
<Tabs items={['xml', 'groovy', 'kotlin']}>
  <Tab value="xml">
    ...
    <dependency>
        ...
        <version>1.14.0</version> <!-- Replace with the current version -->
  ...
  <Tab value="groovy">
    ...
    dependencies {
        compileOnly 'net.flectone.pulse:api:1.14.0' // Replace with the current version
    }
    ```
  </Tab>
  <Tab value="kotlin">
...
<Tabs items={['xml', 'groovy', 'kotlin']}>
  <Tab value="xml">
    ...
    <dependency>
        <groupId>net.flectone.pulse</groupId>
        <artifactId>api</artifactId>
        <version>1.14.1-SNAPSHOT</version> <!-- Replace with the current version -->
        <scope>provided</scope>
    </dependency>
    ```
  </Tab>
  <Tab value="groovy">
    ...
    dependencies {
        compileOnly 'net.flectone.pulse:api:1.14.1-SNAPSHOT' // Replace with the current version
    }
    ```
  </Tab>
  <Tab value="kotlin">
