...
Any module that sends a message also has its own type, which can be [found here](https://github.com/Flectone/FlectonePulse/blob/master/api/src/main/java/net/flectone/pulse/constant/ModuleName.java)
