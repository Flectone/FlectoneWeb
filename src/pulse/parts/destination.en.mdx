...
<div className='flex flex-col gap-4 mb-5'>
    <Accordions>
        <Accordion title={<code>ACTION_BAR</code>} id="action-bar">
    ...
    <Accordions>
        <Accordion title={<code>BOSS_BAR</code>} id="boss-bar">
    ...
    <Accordions>
        <Accordion title={<code>TEXT_SCREEN</code>} id="text-screen">
    ...
    <Accordions>
        <Accordion title={<code>TITLE (or SUBTITLE)</code>} id="title">
    ...
    <Accordions>
        <Accordion title={<code>TOAST</code>} id="toast">
