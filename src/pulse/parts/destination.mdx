...
<Accordions>
    <Accordion title="Как использовать?">
        ...
        <Callout type="info" title="Информация">
            Дополнительные параметры для настройки `destination` появятся сами
        </Callout>
        ...
        <div className='flex flex-col gap-4 mb-5'>
            ...
            <Accordions>
                <Accordion title={<code>BOSS_BAR</code>}>
                    ...
                    Цвет отображения (`PINK`, `BLUE`, `RED`, `GREEN`, `YELLOW`, `PURPLE`, `WHITE`)
            ...
            <Accordions>
                <Accordion title={<code>TEXT_SCREEN</code>}>
                    ...
                    Время в тиках (20 тиков = 1 секунда), сколько будет идти анимация появления и исчезновения. Если будет 0 или меньше, то анимации не будет
            ...
            <Accordions>
                <Accordion title={<code>TOAST</code>}>
                    ...
                    Иконка достижения, которая может быть любым предметом из майнкрафта (нужно обязательно указывать полный путь)

                    `subtext`

                    Описание достижения, не используется
